...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app-simple.css', 'resources/js/app.js']); ?>
    ...
    <section class="relative min-h-screen flex items-center justify-center px-4 py-20">
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="mb-8 animate-fade-in">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Barangay Matina Pangi Logo" class="w-32 h-32 mx-auto rounded-full shadow-2xl glow">
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style="animation-delay: 0.8s;">
                <a href="<?php echo e(route('login')); ?>" class="btn-primary w-full sm:w-auto flex items-center justify-center gap-3">
                    <i data-lucide="user-check" class="w-5 h-5"></i>
                    <span>Login as Secretary</span>
                </a>
                <a href="<?php echo e(route('login')); ?>" class="btn-secondary w-full sm:w-auto flex items-center justify-center gap-3">
    ...
    <footer class="relative py-12 px-4 bg-gray-900 text-white">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-gray-400">
                <p>© <?php echo e(date('Y')); ?> Barangay Matina Pangi. All rights reserved.</p>
...
<?php /**PATH D:\matina_pangi_profiling\resources\views\welcome.blade.php ENDPATH**/ ?>