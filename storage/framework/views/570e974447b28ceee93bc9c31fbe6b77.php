    ...
    <nav class="navbar navbar-top navbar-expand-lg fixed-top">
        <div class="container-fluid">
            ...
            <div class="ms-auto d-flex align-items-center gap-3">
                <span class="badge bg-light text-dark"><?php echo e(now()->format('M d, Y')); ?></span>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text"><strong><?php echo e(ucfirst(auth()->user()->role)); ?></strong></span></li>
    ...
    <div class="sidebar offcanvas-lg offcanvas-start" id="sidebar" tabindex="-1">
        ...
        <div class="offcanvas-body p-0">
            <nav class="nav flex-column py-3">
                ...
                <a href="<?php echo e(route('residents.index')); ?>" class="nav-link <?php echo e(request()->routeIs('residents.*') ? 'active' : ''); ?>">
                    <i class="bi bi-people"></i>
                    <span>Residents</span>
                </a>
                
                <a href="<?php echo e(route('households.index')); ?>" class="nav-link <?php echo e(request()->routeIs('households.*') ? 'active' : ''); ?>">
...
<?php /**PATH D:\matina_pangi_profiling\resources\views\layouts\app-clean.blade.php ENDPATH**/ ?>