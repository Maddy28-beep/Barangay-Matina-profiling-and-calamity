            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-nowrap gap-2 overflow-auto">
                        <a href="<?php echo e(route('puroks.show', $purok)); ?>" class="btn btn-sm btn-primary">
                        ...
                        <form action="<?php echo e(route('puroks.update-counts', $purok)); ?>" method="POST" class="d-inline m-0">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\matina_pangi_profiling\resources\views/puroks/index.blade.php ENDPATH**/ ?>