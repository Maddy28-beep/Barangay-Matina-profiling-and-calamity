          ...
          <tr>
            ...
            <td>
              <div class="btn-group btn-group-sm">
                <a href="<?php echo e(route('web.damage-assessments.show',$a)); ?>" class="btn btn-primary"><i class="bi bi-eye"></i> View</a>
                <a href="<?php echo e(route('web.damage-assessments.edit',$a)); ?>" class="btn btn-warning"><i class="bi bi-pencil"></i> Edit</a>
                <form action="<?php echo e(route('web.damage-assessments.destroy',$a)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this assessment?')">
                  <?php echo csrf_field(); ?>
