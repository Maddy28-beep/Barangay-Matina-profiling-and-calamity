...
<body>
  ...
  <div class="meta">
    Prepared by: <?php echo e($exporter ?? ($calamity->reporter?->name ?? 'N/A')); ?> • Date: <?php echo e(now()->format('F d, Y')); ?>
  ...
  <div class="section signature">
    <div class="grid">
      <div class="col col-2"><div class="sig">Prepared by: <?php echo e($exporter ?? ($calamity->reporter?->name ?? 'N/A')); ?></div></div>
      <div class="col col-2"><div class="sig">Certified by: <?php echo e($barangayCaptain ?? 'Barangay Captain'); ?></div></div>
    </div>
  </div>
</body>
</html>
<?php /**PATH D:\matina_pangi_profiling\resources\views/calamity/reports/pdf.blade.php ENDPATH**/ ?>