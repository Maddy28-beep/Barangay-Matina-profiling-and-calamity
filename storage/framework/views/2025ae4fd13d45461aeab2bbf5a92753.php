<?php $__env->startSection('title', 'Record Calamity'); ?>
...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('calamities.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="date_occurred" id="date_occurred" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\matina_pangi_profiling\resources\views\calamities\create.blade.php ENDPATH**/ ?>