...
<div class="d-flex justify-content-between align-items-end mb-2">
    <h2><i class="bi bi-house-door-fill"></i> Household <span class="no-wrap"><?php echo e($household->household_id); ?></span></h2>
    <div class="btn-group action-buttons" style="max-width: 100%;">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('households.index')); ?>" class="btn btn-secondary btn-back">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="mb-0">
                    ...
                    <span class="no-wrap"><?php echo e($household->household_id); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\matina_pangi_profiling\resources\views/households/show.blade.php ENDPATH**/ ?>