        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_teens'])); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_voters'])); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_4ps'])); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['average_household_size'], 1)); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    <div class="stat-icon"><i class="bi bi-people"></i></div>
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_residents'])); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_households'])); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_senior_citizens'])); ?></h3>
        ...
        <div class="card stat-card h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"><?php echo e(number_format($stats['total_pwd'])); ?></h3>
            ...
            <div class="card-body p-5">
                <div class="row g-4">
                    <?php if(auth()->user()->isSecretary()): ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="action-button-wrapper">
                                <a href="<?php echo e(route('households.create')); ?>" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 text-decoration-none" style="min-height: 56px;">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="action-button-wrapper">
                                <a href="<?php echo e(route('households.index')); ?>" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 text-decoration-none" style="min-height: 56px;">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="action-button-wrapper">
                                <a href="<?php echo e(route('certificates.create')); ?>" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 text-decoration-none" style="min-height: 56px;">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="action-button-wrapper">
                                <a href="<?php echo e(route('census.index')); ?>" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 text-decoration-none" style="min-height: 56px;">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="action-button-wrapper">
                                <a href="<?php echo e(route('settings.users.index')); ?>" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 text-decoration-none" style="min-height: 56px;">
                    ...
                    <?php else: ?>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="action-button-wrapper">
                                <a href="<?php echo e(route('residents.index')); ?>" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 text-decoration-none" style="min-height: 56px;">
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('residents.index')); ?>" class="btn btn-sm btn-outline-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\matina_pangi_profiling\resources\views\dashboard.blade.php ENDPATH**/ ?>