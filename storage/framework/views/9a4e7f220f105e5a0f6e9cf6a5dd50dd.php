    ...
    <aside id="sidebar" class="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full lg:translate-x-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-r border-gray-200 dark:border-gray-700">
        <div class="h-full px-4 py-6 overflow-y-auto">
            ...
            <div class="flex items-center gap-3 mb-8 px-4">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Barangay Logo" class="w-12 h-12 rounded-full shadow-md">
                <div>
            ...
            <nav class="space-y-2">
                ...
                <a href="<?php echo e(route('residents.index')); ?>" class="<?php echo e(request()->routeIs('residents.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    <i data-lucide="users" class="w-5 h-5"></i>
                    <span>Residents</span>
                </a>

                <a href="<?php echo e(route('households.index')); ?>" class="<?php echo e(request()->routeIs('households.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
...
<?php /**PATH D:\matina_pangi_profiling\resources\views\layouts\app-tailwind-backup.blade.php ENDPATH**/ ?>