                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown me-2" id="announcementBell">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span class="badge bg-danger rounded-pill" id="announcementBellCount" style="display: <?php echo e($annCount>0 ? 'inline-block' : 'none'); ?>;"><?php echo e($annCount); ?></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" id="announcementBellMenu">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $latestAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(route('announcements.show', $a)); ?>">
                                            <div class="d-flex align-items-start">
                                                <div class="me-2"><i class="bi bi-megaphone"></i></div>
                                                <div>
                                                    <div class="fw-semibold"><?php echo e(\Illuminate\Support\Str::limit($a->title, 40)); ?></div>
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('announcements.index')); ?>">View all</a></li>
                            </ul>
                        </li>
                        <?php endif; ?>
                ...
                <div class="sidebar-inner">
                    <div class="sidebar-scroll">
                        ...
                        <?php if(auth()->user()->isSuperAdmin()): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="collapse" href="#calamityManagementSubmenu" role="button" aria-expanded="<?php echo e(request()->routeIs('calamities.*') ? 'true' : 'false'); ?>" aria-controls="calamityManagementSubmenu">
                                    <i class="bi bi-lightning-fill"></i>
                                    <span>Calamity Management</span>
                                    <i class="bi bi-chevron-down ms-auto"></i>
                                </a>
                                <div class="collapse <?php echo e(request()->routeIs('calamities.*') ? 'show' : ''); ?>" id="calamityManagementSubmenu">
                                    <ul class="nav flex-column ms-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.calamity-affected-households.index')); ?>">
                                                <i class="bi bi-people"></i>
                                                <span>Affected Residents / Household</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.evacuation-centers.index')); ?>">
                                                <i class="bi bi-building"></i>
                                                <span>Evacuation Center</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.relief-items.index')); ?>">
                                                <i class="bi bi-box-seam"></i>
                                                <span>Relief Goods Inventory</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.relief-distributions.index')); ?>">
                                                <i class="bi bi-truck"></i>
                                                <span>Relief Distribution</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.damage-assessments.index')); ?>">
                                                <i class="bi bi-clipboard-check"></i>
                                                <span>Damage Assessment & Reporting</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.notifications.index')); ?>">
                                                <i class="bi bi-megaphone"></i>
                                                <span>Emergency Notification / Announcement</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.response-team-members.index')); ?>">
                                                <i class="bi bi-people-fill"></i>
                                                <span>Calamity Response Team / Volunteers</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('web.calamity-reports.index')); ?>">
                        ...
                        <?php endif; ?>
                        <?php if(auth()->user()->isCalamityHead()): ?>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="collapse" href="#calamityManagementSubmenu" role="button" aria-expanded="<?php echo e(request()->routeIs('calamities.*') ? 'true' : 'false'); ?>" aria-controls="calamityManagementSubmenu">
                                    <i class="bi bi-lightning-fill"></i>
                                    <span>Calamity Management</span>
    ...
    <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 9999;">
        <div id="successToast" class="toast toast-success" role="alert" data-bs-autohide="true" data-bs-delay="2500">
            ...
            <div class="toast-body">
                <?php echo e(session('success') ?? 'Action completed successfully!'); ?>
...
<?php /**PATH D:\matina_pangi_profiling\resources\views/layouts/app.blade.php ENDPATH**/ ?>